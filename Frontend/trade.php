    ...
    <div class="col-lg-9 col-md-9">
      ...
      <?php
            ...
            while($player = mysqli_fetch_assoc($result)) {
              echo "<div class='news-link'><img class='poster' src='/img/jordan.png' /><span class='hot-news'>" . $player["playerPrice"] . "</span><h3 class='news-log' style='text-align: center; margin-right:60px;'>" . $player["playerName"] . "</h3><a href='trade.php' class='btn-view' style='margin-top:25px; margin-right:130px'><span class='ic-sx24'></span> Buy</a><a href='trade.php' class='btn-view' style='margin-right:150px; margin-top:25px'><span class='ic-sx24'></span> Sell</a></div>";
            }
        ?>
      </div>
